---
title: "compstatsR:<br>simulation workflows and distributed computing"
author: "Ben Bolker"
date: "19 March 2026"
...
- sample combinations of parameters without replacement
...
## SHARCnet/Compute Canada basics

- [register with Compute Canada](https://www.alliancecan.ca/en/our-services/advanced-research-computing/account-management/apply-account) (ask your advisor for their CC id)
- logging in: `ssh`
- copying files: `scp`, `rsync`
- submitting jobs: `sqsub`
- checking jobs: `sqjobs`
- special stuff for R
    - see [notes](https://hackmd.io/@bbolker/r_hpc)
    - install packages interactively, from head node
	- need `module load r/<VERSION>` in scripts

## Source

https://bbolker.github.io/compstatsR

```{r qrcode, echo = FALSE, out.width = "90%"}
library("qrcode")
